    ...
    <div className='w-full h-[90vh]'>
      ...
      <div className='max-w-[1140px] m-auto'>
        <div className='absolute top-[40%] w-full md:-[50%] max-w-[600px] flex flex-col text-white p-4'>
          ...
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloremque quas, accusamus debitis quae officia, soluta est voluptatum ducimus, optio exercitationem ad? Officiis sed laborum nemo ullam, quisquam sequi. Beatae, mollitia.
          </p>
        </div>
      </div>
    </div>
